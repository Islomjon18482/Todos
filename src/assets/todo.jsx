...
const Todo = () => {
  ...
  return (
    <>
      <div className="block">
        <div className="inp__sub">
          <div className="border">
            <input onChange={(e) => setInp(e.target.value)} value={inp} type="text" placeholder="Enter to do here..."/>
